...
def main():
    ...
    parser.add_argument("--num_ab_classes", '-num_ab', type=int, default=25,
    ...
    parser.add_argument("--downsample_size", '-num_pixels', type=int, default=16,
    ...
    finetuned_weight_name = os.path.join(file_path,"%s/sb_finetuned_%s.pth" % (args.weights_folder, args.model_type))
